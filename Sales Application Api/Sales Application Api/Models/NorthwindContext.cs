...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<Tblrating1> Tblrating1s { get; set; }

    public virtual DbSet<Territory> Territories { get; set; }

    public virtual DbSet<VCategoryname> VCategorynames { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>(entity =>
        {
            ...
            entity.HasIndex(e => e.CategoryName, "i_categoryname");
        ...
        {
            entity.HasKey(e => e.Cid).HasName("PK__customer__D837D05F3A74EEDB");
        ...
        modelBuilder.Entity<Customer1>(entity =>
        {
            ...
            entity.HasIndex(e => e.ContactName, "i_con");

            entity.HasIndex(e => e.CustomerId, "i_name");
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasIndex(e => e.FirstName, "i_firstname");

            entity.HasIndex(e => e.LastName, "i_laStname").IsUnique();
        ...
        {
            entity.HasKey(e => e.Poid).HasName("PK__purchase__41A66D88E6FF1405");
            ...
            entity.Property(e => e.Poidate).HasColumnType("datetime");

            entity.HasOne(d => d.CidNavigation).WithMany(p => p.PurchaseOrders)
                .HasForeignKey(d => d.Cid)
                .HasConstraintName("FK__purchaseOrd__cid__17F790F9");
        });
        ...
        modelBuilder.Entity<Region>(entity =>
        {
            ...
            entity.ToTable("Region", tb => tb.HasTrigger("tgr_delete_Region"));
        ...
        modelBuilder.Entity<TblTerritory>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("tbl_territories", tb => tb.HasTrigger("tgr_insert"));
            ...
            entity.HasOne(d => d.TIdNavigation).WithMany()
                ...
                .HasConstraintName("FK__tbl_territo__tId__6CD828CA");
        });
        ...
        modelBuilder.Entity<Tblrating>(entity =>
        {
            ...
            entity.Property(e => e.Decriptiption)
                .HasMaxLength(50)
                .HasColumnName("decriptiption");
        ...
        modelBuilder.Entity<Tblrating1>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("tblrating1");
        ...
        modelBuilder.Entity<Territory>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasTrigger("tgr_delete_territories"));
        ...
        modelBuilder.Entity<VCategoryname>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("v_categoryname");
